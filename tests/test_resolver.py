...
import especifico.apps
from especifico.exceptions import ResolverError
from especifico.operations import Swagger2Operation
from especifico.resolver import RelativeResolver, Resolver, RestyResolver
...
def test_standard_get_function():
    function = Resolver().resolve_function_from_operation_id(
        "especifico.FlaskApp.common_error_handler",
    )
    assert function == especifico.FlaskApp.common_error_handler


def test_relative_get_function():
    function = RelativeResolver("especifico").resolve_function_from_operation_id(
        "especifico.FlaskApp.common_error_handler",
    )
    assert function == especifico.FlaskApp.common_error_handler
...
def test_resty_get_function():
    function = RestyResolver("especifico").resolve_function_from_operation_id(
        "especifico.FlaskApp.common_error_handler",
    )
    assert function == especifico.FlaskApp.common_error_handler
...
def test_resty_resolve_with_default_module_name_and_x_router_controller_will_resolve_resource_root_get_as_search():  # noqa
    operation = Swagger2Operation(
        api=None,
        method="GET",
        path="/hello",
