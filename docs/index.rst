.. Específico documentation master file, created by
   sphinx-quickstart on Wed Jun 17 12:09:55 2015.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to Específico's documentation!
=====================================

Específico is a framework on top of Flask_ that automagically handles
HTTP requests defined using `OpenAPI`_ (formerly known
as Swagger), supporting both `v2.0`_ and `v3.0`_ of the specification. 

Específico allows you to write these specifications, then maps the
...
you want and then Específico guarantees that it will work as
you specified. We built Específico this way in order to:
