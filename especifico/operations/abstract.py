...
from especifico.operations.secure import SecureOperation
...
logger = logging.getLogger("especifico.operations.abstract")
...
class AbstractOperation(SecureOperation, metaclass=abc.ABCMeta):
    ...
    def function(self):
        ...
        # NOTE: the security decorator should be applied last to check auth
    ...
    def __content_type_decorator(self):
        ...
        **Produces**
        ...
        the Swagger Object. An empty value MAY be used to clear the global definition.
