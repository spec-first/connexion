"""
This module defines a Swagger2Operation class, a Especifico operation specific for Swagger 2 specs.
"""
...
logger = logging.getLogger("especifico.operations.swagger2")
