"""
This module defines a SecureOperation class, which implements the security handler for
an operation.
"""
...
logger = logging.getLogger("especifico.operations.secure")
...
class SecureOperation:
            ...
            for scheme_name, required_scopes in security_req.items():
                ...
                if security_scheme["type"] == "oauth2":
                    if oauth:
                        ...
                        break
                    oauth = True
                    token_info_func = self._api.security_handler_factory.get_tokeninfo_func(
                        security_scheme,
                    )
                    scope_validate_func = (
                        self._api.security_handler_factory.get_scope_validate_func(security_scheme)
                    )
                ...
                # Swagger 2.0
                    ...
                    basic_info_func = self._api.security_handler_factory.get_basicinfo_func(
                        security_scheme,
                    )
                    ...
                    sec_req_funcs[scheme_name] = self._api.security_handler_factory.verify_basic(
                        basic_info_func,
                    )
                ...
                # OpenAPI 3.0.0
                    ...
                    if scheme == "basic":
                        ...
                        bearer_info_func = self._api.security_handler_factory.get_bearerinfo_func(
                            security_scheme,
                        )
                        ...
                        sec_req_funcs[
                            scheme_name
                        ] = self._api.security_handler_factory.verify_bearer(bearer_info_func)
                    else:
                        logger.warning(
                    ...
                    if scheme == "bearer":
                        ...
                        apikey_info_func = self._api.security_handler_factory.get_apikeyinfo_func(
                            security_scheme,
                        )
                ...
                if len(sec_req_funcs) == 1:
                    ...
                    auth_funcs.append(
                        self._api.security_handler_factory.verify_multiple_schemes(sec_req_funcs),
                    )
    ...
    def _request_response_decorator(self):
        ...
        (especifico.lifecycle.EspecificoRequest) a framework specific
        object is returned.
        :rtype: types.FunctionType
        """
