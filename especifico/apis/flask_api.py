...
class FlaskApi(AbstractAPI):
    ...
    def get_request(cls, *args, **params):
        # type: (*Any, **Any) -> EspecificoRequest
        ...
        """
        context_dict = {}
        setattr(flask._request_ctx_stack.top, 'especifico_context', context_dict)
...
def _get_context():
    return getattr(flask._request_ctx_stack.top, 'especifico_context')
